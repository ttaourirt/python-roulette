...
# url = "https://www.amazon.fr/dp/B08HBQWBHH/" #lien 3090
# url2 = "https://www.amazon.fr//dp/B08H93ZRK9" #LIEN PS5

# headers = {"USER-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/88.0.4324.190 Safari/537.36"}

# page = get(url2, headers=headers)

# # print(page.content) soupe indigeste
...
def affichage(titre, availability, prix, color):
    ...
    print(colored(titre + " " + availability + " " + prix, color))
